...
function goo.addElement(name,   -- Use this as a template of creating gooey elements
    ...
    if goo.elements[name] then return end -- Return if the element already exists
    ...
    -- Allows frames to draw chilren above other elements
    goo.elements[name].drawFunc = drawindividualfunction
